...
var ls_setting='';
	...
	ls_setting+='<td valign="top"><select id="cal_difference"><option value="5">5 </option><option value="10">10 </option><option value="15">15 </option><option  value="20">20 </option><option value="30">30 </option><option value="60" selected="selected">60 </option></select> Min.</td></tr><tr><td valign="top">Set row width: </td><td valign="top"><input type="text" value="150" id="set_row_width" size="3">.px</td>';
	ls_setting+='</tr><tr>';
