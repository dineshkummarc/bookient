...
class email_mkt_manager extends Pardco {
	public function __construct()
	{
		parent::__construct();
		$this->load->helper('url');
		$this->load->model('superadmin/email_mkt_manager_model');
	...
	public function index()
	{
		...
		$data['all'] = $this->email_mkt_manager_model->GetAllCategory(); 
		$data['category'] = $this->email_mkt_manager_model->category(); 
		$this->load->view('superadmin/email_mkt_manager/email_mkt_manager',$data);		
	...
	{
		$this->email_mkt_manager_model->SaveTIMEZONE();
		$return=$this->email_mkt_manager_model->GetAllCategory();
		echo $return;
	}
	/*
	...
	*/
	...
	{
		$this->email_mkt_manager_model->EditTIMEZONE();
	}
