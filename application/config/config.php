...
|--------------------------------------------------------------------------
|
| Typically IDs for database rows
|
*/

$config['default_plan_id'] = 1;
$config['superadmin_id'] = 1;
...
/*echo'<pre>';
print_r(unserialize($_COOKIE['ci_session']));
echo'</pre>';*/
$default_lang = "";
if(isset($_COOKIE['ci_session']))
{
        $arr_val = unserialize($_COOKIE['ci_session']);
        if(isset($arr_val['selected_lang']))
        {
            $default_lang = strtolower($arr_val['selected_lang']) ;
        }
        else
        {
            if(isset($arr_val['default_language_type']))
            {
                $default_lang = strtolower($arr_val['default_language_type']) ;
            }
            else {
...
|
*/
$config['encryption_key'] = 'SandiCityTech#123456789';
