	...
	<h2 class="text-center"></h2>
		<form id="form-login" class="styled" action="" method="post">
			  ...
			  <ol>
				...
				<li class="button-row">
               	 <input type="button" id="user_email" onclick="window.location.href='<?php  echo base_url(); ?>staff'" value=""  class="back_forgot" />
                 &nbsp;
				 <input type="button" src="<?php  echo base_url(); ?>images/login2.jpg" alt="Go" value="Go" class="btn-blue btn-submit-login img-swap" />
				</li>
