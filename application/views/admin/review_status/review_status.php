...
<?php   //echo '<pre>';print_r($ResArr);exit; ?>
<div class="rounded_corner_full">
    ...
    <div class="<?php echo $outer;?>">
            ...
            <tr>	 	
                <td>
                   ...
                   <?php echo $this->lang->line('by'); ?> 
                   		<?php echo $result['cus_fname'].' '.$result['cus_lname']; ?>
        ...
        <div class="review-inner">
            <a class="review-view-details-link" href="javascript:void(0);"><?php echo $this->lang->line('view_details'); ?></a>
                ...
                <table width="30%" border="0" cellspacing="3" cellpadding="0">		
                    <tr>	 	
                        ...
                        <td>
                            ...
                            <?php echo ($result['srvDtls_service_duration_unit'] =="M")?"min":''; ?>&nbsp;<?php echo $this->lang->line('by'); ?>&nbsp;
                            <?php echo (isset($result['srvDtls_employee_name']))?$result['srvDtls_employee_name']:''; ?>&nbsp;<?php echo $this->lang->line('from'); ?>&nbsp;
