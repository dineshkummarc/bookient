<div id="detacontain"><div id="out">
    ...
    <div class="left-drop">
     <h2 class="left-droph2"><?php echo $this->global_mod->db_parse($this->lang->line('global_staff')); ?></h2>
      <ul id="cal_staff">
	  <?php
	 /* echo '<pre>';
		print_r($service);
    ...
    <div class="left-drop">
    <h2 class="left-droph2"><?php echo $this->global_mod->db_parse($this->lang->line('global_service')); ?></h2>
      <ul  id="cal_services">         
		<?php 
