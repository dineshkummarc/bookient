...
<script type="text/javascript" src="<?= base_url(); ?>asset/FusionCharts.js"></script>
...
echo $graphObj-> renderChart(base_url()."asset/FCF_Column3D.swf", "", $strXMLbar, "weekwise", 350, 250);
echo '</td>';
//echo '</div>';
...
echo $graphObj-> renderChart(base_url()."asset/FCF_Column3D.swf", "", $strXMLbar, "staffwise", 350, 250);
echo '</td>';
//echo '</div>';
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/*@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@*/
...
//echo '<div style="border:1px solid #022157; width: 350px;">';
echo '<td style="border:1px solid #CCCCCC;">';
echo $graphObj-> renderChart(base_url()."asset/FCF_Column3D.swf", "", $strXMLbar, "servicewise", 350, 250);
echo '</td></tr></table>';
echo '</div>';
/*@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@*/
