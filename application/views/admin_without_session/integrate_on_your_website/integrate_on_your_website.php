        ...
        <div id="tabContent">
            ...
            <br />
             <div class="inner-div">
                ...
                <script>function fbs_click() {u=location.hostname;t=document.title;window.open('http://www.facebook.com/sharer.php?u='+encodeURIComponent(u)+'&t='+encodeURIComponent(t),'sharer','toolbar=0,status=0,width=626,height=436');return false;}</script><!--<a rel="nofollow" href="http://www.facebook.com/share.php?u=<;url>" onclick="return fbs_click()" target="_blank" id="share_facebook" class="btn-blue">Share on Facebook</a>-->
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>-->
                <!--<a href="https://twitter.com/share" class="btn-blue" data-count="none">SHARE ON TWITTER</a>-->
                <script>
                function twitter()
                {//alert("KKK");
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
            ...
            <div class="inner-div">
            <br />
            <h2>3. Invite your Contacts from your Gmail </h2>
            <br />
             <div class="inner-div">
                <h3> Let your current customers and friends know about your Bookient.</h3>     
                <br />
                <input type="button" name="on_website" id="on_website" value="Import & Invite Contacts" class="btn-blue" onClick="importGmailContact();" />
                <br />
             </div>
            </div>
        </div>
