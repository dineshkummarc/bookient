...
<h1 class="headign-main">BUSINESS</h1>
			...
			<td>
				...
				if($business_logo != "")
				{
					?> <img id="staffImg" src="<?php echo base_url(); ?>uploads/businesslogo/<?php echo $business_logo; ?>" height="80"  />
                                         <br/><a id="rem_photo" href="JavaScript:void(0);" onclick="Remove_Pic()" >Remove Photo</a>
	...
	<table style="padding-left:30px" width="80%" class="bussiness-tabl">
		...
		<tr>
		    <td>
                        ...
                        <td>e.g. Beauty Salon in Miami</td>
		</tr>
		<tr>
			<td>
...
<?php echo $this->lang->line('business_location_details'); ?>
   ...
   <br/>
	<table style="padding-left:30px" width="80%" class="bussiness-tabl" >
		...
		<tr>
			<td>
			<?php //echo $this->lang->line('business_city_region'); ?>State
			</td>
         ...
         <tr>
         <td>
			<?php //echo $this->lang->line('business_city_region'); ?>City
			</td><td>
			<?php echo $city; ?>
			</td>
		</tr>
...
<h2>5. Add your business links</h2><br/>
<div class="inner-div">
<table style="padding-left:30px" width="80%" class="bussiness-tabl">
  <tr>
    <td>Facebook Link : </td>
...
<div style="margin:20px; text-align:center;"><p><input type="button" name="save_business" value="save" id="btn-submit1" class="btn-blue"></p> </div>
</form>
</div>