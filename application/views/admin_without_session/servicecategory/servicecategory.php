...
<div id="add_new_link" class="margin-adjust">
	<a href="javascript:void(0);" onclick="hide_show_tbl();" class="add-items"><strong><img src="<?php echo base_url(); ?>images/Add-faq.png" alt="" title="Add SERVICE CATEGORY" />ADD SERVICE CATEGORY</strong></a>
</div>
...
<table width="60%" border="0" cellspacing="0" cellpadding="0" class="credit-table">
  ...
  <tr>
      <td>&nbsp;</td>
  	<td  align="left">
    	<input type="button" name="sub_servicecategory" id="sub_servicecategory" value="Add" class="btn-blue" onclick="submit_servicecategory()" style="padding:3px 8px;" /> 
        &nbsp; 
        <input type="button" name="cancel_servicecategory" id="cancel_servicecategory" value="Cancel" class="btn-gray" onclick="cancl_servicecategory();" style="padding:3px 8px;"/>
     </td>
  </tr>
</table>
</form>
...
<table class="list-view" width="98%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <th align="left" width="50%">Category Name</th>
        <th align="left" width="20%">Status</th>
        <th align="center" width="20%" colspan="2">Action</th>
    </tr>    
<?php
if(count($all)>0){
