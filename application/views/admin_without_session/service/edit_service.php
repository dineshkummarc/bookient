...
<div class="wrap">
    <form name="edit_service" id="edit_service" class="styled" action="<?php echo base_url();?>admin/service/update_service/<?php echo $service[0]['service_id'];?>" method="post">
        <fieldset>
             ...
             <ol>
             	<li class="form-row">
                	<label><?php echo $this->lang->line('ser_category'); ?> : </label><?php echo $service[0]['category_name'];?>
            	...
            	<li class="form-row">
                    ...
                    <input type="text" name="service_name" id="service_name" autocomplete="off" value="<?php echo $service[0]['service_name'];?>" class="text-input required" maxlength="30"/>
                </li>
                ...
                <li class="form-row">
                    ...
                    <textarea name="service_description" id="service_description" class="text-input-staff-txtAra required" onKeyDown="textCounter(document.add_service.service_description,document.add_service.remLen1,125)" onKeyUp="textCounter(document.add_service.service_description,document.add_service.remLen1,125)"><?php echo $service[0]['service_description'];?></textarea>
                ...
                <li class="form-row">
                    ...
                    <textarea name="service_tags" id="service_tags" class="text-input-staff-txtAra required" onKeyDown="textCounter(document.add_service.service_tags,document.add_service.remLen2,125)" onKeyUp="textCounter(document.add_service.service_tags,document.add_service.remLen2,125)"><?php echo $service[0]['service_tags'];?></textarea>
