        ...
        success: function(result){
            if(result == 0){
	            ...
	            $.ajax({
	                type: 'POST',
	                datatype:'html',
	                url: "<?php echo base_url(); ?>superadmin/dashboard/email_varify",
	                data: { 'user_id': id },
	                success:function(){
	                     location.reload();
	                }
        ...
        success: function(result){
            if(result == 0){
	            ...
	            $.ajax({
	                type: 'POST',
	                datatype:'html',
	                url: "<?php echo base_url(); ?>superadmin/dashboard/delete_account",
	                data: { 'user_id': id },
	                success:function(){
	                     location.reload();
	                }
...
<script type="text/javascript">
function manage_local_admin(id,url_ls)
{
	$.ajax({
	    type: 'POST',
	    datatype:'html',
	    ...
	    success:function(rdata)
	    {
	        ...
	        else
	        {
                ...
                if (count== 2)
                {
                    var url =  window.location.protocol + "//"+url_ls+ "/admin/manage_local_admin/check_user_access/"+rdata;
