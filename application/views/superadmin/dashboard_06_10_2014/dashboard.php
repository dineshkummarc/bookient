...
<h1 class="headign-main-superadmin">Dashboard</h1>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class=" super-listing-tabl">
      ...
      <tr>
        ...
        <td align="left"><?php echo $row['user_name'].'.'.$_SERVER['HTTP_HOST']; ?></td>
        <td align="center"><?php echo $row['mobile_phone']; ?></td>
        <td align="center"><?php echo $row['is_email_verified']; ?></td>
        <td align="center">
        ...
        <td align="center"><a href="javascript:void(0);" onclick="manage_local_admin('<?php echo $row['local_admin_id']; ?>');">Manage Local Admin</a></td>
      </tr>
      <?php } ?>
    </table>
</div>
